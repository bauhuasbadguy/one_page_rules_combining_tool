...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 25 15:24:13 2021

@author: stuart
"""

#combine age of fantasy regiments rules
...
baseFolder = './rules/ageOfFantasyRegimentsRules'
...
armyListMerger.write(fileobj=open('AoFR_armyLists.pdf', 'wb'))
armyListMerger.close()

#create GDFF full rules

armyListFiles.insert(0, 'AoFR - Basic Rulebook v2.12.pdf')
...
allMerger.write(fileobj = open('AoFR_full_rules.pdf', 'wb'))
allMerger.close()